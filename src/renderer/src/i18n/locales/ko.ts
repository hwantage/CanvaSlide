...
파일 제작은 {skill} 스킬을 참고하세요.`,
  ...
  'site.docs.frames.presentBody':
    '{start}로 시작해 {next}로 다음 장면, {previous}로 이전 장면을 보세요. {escape}를 누르면 슬라이드 쇼가 끝납니다. 카메라는 프레임을 화면에 맞추고 장면 사이를 부드럽게 이동합니다. 컨트롤 막대는 발표 중에 화면에서 사라지고, 포인터를 화면 아래 끝으로 옮기면 다시 나타납니다.',
