...
- **발표:** 프레임 순서·미리보기를 관리하고 내부 내용과 함께 이동하며 전환을 일괄 편집합니다.
  ...
  앱·클라우드 발표·새로 내보낸 HTML에서 자동 숨김 컨트롤과 레이저·임시 잉크를 함께 제공합니다.
  P로 포인터를 켜고 드래그해 그리며 E로 지웁니다. 좁은 화면에서는 도구 메뉴를 사용합니다.
  포인터를 끄거나 전체 보기를 왕복해도 잉크는 남고, 다른 프레임으로 이동하거나 발표를 끝내면 지워집니다.
  문서에는 저장되지 않습니다. HTML은 밝은 테마·영어를 유지하며, 기존 내보내기 파일은 다시 생성해야 합니다.
