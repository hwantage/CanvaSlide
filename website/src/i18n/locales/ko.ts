...
export const ko: SiteStrings = {
  ...
  'site.docs.shortcuts.presentFromSelection': '현재 프레임부터 슬라이드 쇼',
  ...
  'site.docs.shortcuts.help': '키보드 단축키 (편집기)',
  'site.docs.shortcuts.next': '다음 / 이전 프레임',
  'site.docs.shortcuts.overview': '개요 전환 (슬라이드 쇼)',
  'site.docs.shortcuts.pointer': '레이저 포인터 전환 — 드래그하면 그려집니다 (슬라이드 쇼)',
  'site.docs.shortcuts.clearInk': '잉크 모두 지우기 (슬라이드 쇼)',
  ...
  'site.docs.faq.networkLink': 'README의 네트워크와 개인정보',
