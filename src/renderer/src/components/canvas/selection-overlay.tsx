...
import { worldRectToScreen, worldToScreen } from '@shared/canvas/camera-transform'
...
export function SelectionOverlay({
  ...
  if (only?.type === 'connector') {
    return <ConnectorEndHandles connector={only} onConnectorEndDown={onConnectorEndDown} />
  }
